...
//   match,
MenuItemProps) {
  const backgroundImageClass = "w-full h-full bg-center bg-cover hover:scale-[1.1] transition-transform duration-[6000ms] ease-[cubic-bezier(0.25,0.45,0.45,0.95)]";
